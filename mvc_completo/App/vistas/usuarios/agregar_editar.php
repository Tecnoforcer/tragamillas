...
<?php
    if (isset($datos['usuario']->id_user)){
        $accion = "Modificar";
    } else {
        $accion = "Agregar";
    }
...
<div class="card bg-light mt-5 w-75 card-center" style=" margin: auto;">
    ...
    <form method="post" class="card-body">
        ...
        <div class="mb-3">
            <label for="telefono">Talla: <sup>*</sup></label>
            <input type="text" name="talla" id="talla" class="form-control form-control-lg" value="<?php echo $datos['usuario']->talla ?>">
        </div>
        ...
        <div class="mb-3">
            ...
            <select name="rol" id="rol" class="form-select form-select-lg">
                <?php foreach($datos['listaRoles'] as $rol): ?>
                    <?php if ($rol->rol == $datos['usuario']->rol):?>
